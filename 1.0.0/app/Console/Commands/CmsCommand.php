...
class CmsCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:cms {name} {--model=}';
    ...
    {
        return Config::get('cms.directory_eloquent_path');
    }
    private function getModelDirectory()
    {
        return Config::get('cms.model_path');
    }
    ...
    {
        return Config::get('cms.directory_path');
    }
    ...
    private function getRepositoryName()
    {
        ...
        if((strlen($repositoryName) < strlen('Repository')) || strpos($repositoryName, 'Repository') == false){
    ...
    {
        $stubs = [
            'Eloquent' => $this->files->get(__DIR__.DIRECTORY_SEPARATOR.'stubs'.DIRECTORY_SEPARATOR.'repository.stub'),
            'Interface' => $this->files->get(__DIR__.DIRECTORY_SEPARATOR.'stubs'.DIRECTORY_SEPARATOR.'repository_interface.stub'),
            'Model' => $this->files->get(__DIR__.DIRECTORY_SEPARATOR.'stubs'.DIRECTORY_SEPARATOR.'model.stub'),
        ];
    ...
    {
        $repositoryNamespace     = Config::get('cms.repository_namespace');
        $modelNamespace        = 'App\Models\\'.$this->getModelName();
        $repositoryInterfaceNamespace = Config::get('cms.repository_interface_namespace');
        ...
        $templateVar = [
            ...
            'model_var_name'         => snake_case($modelName),
        ];
