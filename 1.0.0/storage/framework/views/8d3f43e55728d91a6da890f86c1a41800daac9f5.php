                ...
                <form class="layui-form" action="" lay-filter="fb-form">
                    <div class="layui-block mb10 table-search">
                        <div class="layui-inline">
                            <input class="layui-input search_key" name="nickname" id="demoReload" placeholder="<?php echo e(trans('user.label.nickname')); ?>" autocomplete="off">
                        </div>
                        <div class="layui-inline">
                            <input class="layui-input search_key" name="phone" id="demoReload" placeholder="<?php echo e(trans('user.label.phone')); ?>" autocomplete="off">
                        </div>
    ...
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'nickname',title:'<?php echo trans('user.label.nickname'); ?>'}
                ,{field:'avatar_url',title:'<?php echo trans('user.label.avatar_url'); ?>',toolbar:'#avatar_url_tem'}
                ,{field:'phone',title:'<?php echo trans('user.label.phone'); ?>'}
                ,{field:'created_at',title:'<?php echo e(trans('user.label.created_at')); ?>'}
            ]]
            ,id: 'fb-table'
            ,page: true
            ,limit: 10
