        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="<?php echo e(guard_url('job/create')); ?>"><?php echo e(trans('app.add')); ?><?php echo e(trans('job.name')); ?></a></button>
...
<script>
    var main_url = "<?php echo e(guard_url('job')); ?>";
    var delete_all_url = "<?php echo e(guard_url('job/destroyAll')); ?>";
