        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="<?php echo e(guard_url('permission/create')); ?>"><?php echo e(trans('app.add')); ?><?php echo e(trans('permission.name')); ?></a></button>
