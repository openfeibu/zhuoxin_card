        ...
        <div class="layui-col-md12">
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="{{guard_url('job_category/create')}}">{{ trans('app.add') }}</a></button>
...
<script>
    var main_url = "{{guard_url('job_category')}}";
    var delete_all_url = "{{guard_url('job_category/destroyAll')}}";
