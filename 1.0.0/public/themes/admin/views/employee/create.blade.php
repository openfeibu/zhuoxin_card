            ...
            <div class="fb-main-table">
                <form class="layui-form" action="{{guard_url('employee')}}" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="phone_number" lay-verify="required" autocomplete="off" placeholder="请输入{{ trans('app.phone_number') }}" class="layui-input" >
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">* {{ trans('app.tel') }}</label>
                        <div class="layui-input-inline">
                            <input type="text" name="tel" lay-verify="required" autocomplete="off" placeholder="请输入{{ trans('app.tel') }}" class="layui-input" >
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">* {{ trans('app.email') }}</label>
                        <div class="layui-input-inline">
                            <input type="text" name="email" lay-verify="required" autocomplete="off" placeholder="请输入{{ trans('app.email') }}" class="layui-input" >
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">* {{ trans('app.address') }}</label>
                        <div class="layui-input-inline">
                            <input type="text" name="address" lay-verify="required" autocomplete="off" placeholder="请输入{{ trans('app.address') }}" class="layui-input" >
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">* 英文{{ trans('app.address') }}</label>
                        <div class="layui-input-inline">
                            <input type="text" name="en_address" lay-verify="required" autocomplete="off" placeholder="请输入英文{{ trans('app.address') }}" class="layui-input" >
                        </div>
                    </div>
                    <div class="layui-form-item">
