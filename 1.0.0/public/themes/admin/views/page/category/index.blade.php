...
<div class="x-body">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <th>{!! trans('category.label.slug')!!}</th>
            <th>{!! trans('category.label.order')!!}</th>
        ...
        @foreach($data as $key => $val)
            <tr>
                ...
                <td>{{ $val['order'] }}</td>
                <td class="td-manage">
                    <a title="查看"  onclick="x_admin_show('{{ trans('app.edit') }}','{!!guard_url('page/category')!!}/{{ $val['id'] }}')" href="javascript:;">
